...
///////////////////////1ª PARTE/////////////////////////////////////////////////        
        ...
        //Convertendo para bin�rio e depois string
...
///////////////FIM DA 1ª PARTE///////////////////////////////////////////
    ...
    public String realizarCriptografia(String text, String key1, String key2) {
        ...
        //preeche os array com cada n�mero das keys
        try {            
            ...
            try {
                //Se a chave tiver apenas n�meros
                for (int i = 0; i < key1.length(); i++) {
                ...
                System.out.println("Chave inv�lida. Erro: " + ex1.toString());
            }
        }
